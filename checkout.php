                    ...
                    <div class="col-6">
                        ...
                        <h4 class="text-muted">Payment Method</h4>
                            <div class="d-flex w-100 justify-content-between">
								...
								<a href="javascript:void(0)" class="btn btn-sm btn-primary float-right buy_now" data-amount="1280" data-id="3">Razorpay</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
  ...
  $('body').on('click', '.buy_now', function(e){
    ...
    "name": "PET NEEDS",
    "description": "Payment",
    "image": "https://i.pinimg.com/originals/8c/75/86/8c7586997c9c6c97c35610b11b6301f1.png",
